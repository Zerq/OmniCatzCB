import { ReadAloud, MoveTo, ActionBase } from "../model/EditorModel.js";
...
export class EditorController {
    ...
    */
    ...
    drop(e) {
        ...
        let top = Math.min(
            Math.max(y - offsetY + headerRect.height + mainApplicationHeaderRect.height, headerRect.height +  mainApplicationHeaderRect.height),
                (mainRect.height + headerRect.height + mainApplicationHeaderRect.height) - boxRect.height);
